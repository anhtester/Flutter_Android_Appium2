...
public class ExcelHelpers {
        ...
        try {
            ...
            if (sheetName.isEmpty()) {
                try {
                    ...
                    throw new RuntimeException("The Sheet Name is empty.");
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public void setExcelFile(String sheetName) {
        String excelPath = PropertiesHelpers.getValue("EXCEL_DATA_FILE_PATH");
        LogUtils.info("Set Excel File: " + excelPath);
        LogUtils.info("Sheet Name: " + sheetName);
    ...
    public void setCellData(String text, String columnName,int rowNumber) {
        try {
            ...
            LogUtils.info("Set data to excel successfully.");
