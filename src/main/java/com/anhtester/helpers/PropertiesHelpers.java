...
public class PropertiesHelpers {
    ...
    public static Properties loadAllFiles() {
        ...
        try {
            ...
            file.close();
//            LogUtils.info("⚙\uFE0F Loaded all properties files.");
//            LogUtils.info(properties);
    ...
    public static void setFile(String relPropertiesFilePath) {
        ...
        try {
            ...
            LogUtils.warn("❌ Warning !! Can not set Properties file." + relPropertiesFilePath);
            e.printStackTrace();
        }
    }
    ...
    public static String getValue(String key) {
        ...
        try {
            ...
            LogUtils.error(e.getMessage()+ key);
            return keyValue;
        }
    }
    ...
    public static void setValue(String key, String keyValue) {
        try {
            ...
            LogUtils.error(e.getMessage() + linkFile);
        }
    }
